...
import 'package:contest_user_app/Screens/User_Winner.dart';
                            ...
                            : Card(
                                child: ListTile(
                                  ...
                                  onTap: () => {
                                    ...
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => UserWinner()))
                                    // _showDialogemail(winner),
                                    // print(list[index].id),
                                  },
                                ),
                              ));
